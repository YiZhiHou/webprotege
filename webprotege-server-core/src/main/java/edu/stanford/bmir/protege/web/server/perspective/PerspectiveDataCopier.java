...
//            copyPerspectiveFile("类.json");
//            copyPerspectiveFile("属性.json");
//            copyPerspectiveFile("个体.json");
//            copyPerspectiveFile("评论.json");
//            copyPerspectiveFile("实体变更.json");
//            copyPerspectiveFile("历史.json");
//            copyPerspectiveFile("查询.json");
//            copyPerspectiveFile("OWL类.json");
//            copyPerspectiveFile("OWL属性.json");
