...
public class LogOutUserResult implements Result {
    ...
    public String logoutInfoJson;

    public LogOutUserResult(@Nonnull UserInSession userInSession, @Nonnull String logoutInfoJson) {
        this.userInSession = checkNotNull(userInSession);
        this.logoutInfoJson = logoutInfoJson;
    }
