...
public class LogOutUserResult_TestCase {
    ...
    @Before
    public void setUp() {
        logOutUserResult = new LogOutUserResult(userInSession, null);
    }

    @SuppressWarnings("ConstantConditions")
    @Test(expected = NullPointerException.class)
    public void shouldThrowNullPointerExceptionIf_userInSession_IsNull() {
        new LogOutUserResult(null, null);
    }
    ...
    public void shouldBeEqualToOther() {
        assertThat(logOutUserResult, is(new LogOutUserResult(userInSession, null)));
    }

    @Test
    public void shouldNotBeEqualToOtherThatHasDifferent_userInSession() {
        assertThat(logOutUserResult, is(not(new LogOutUserResult(Mockito.mock(UserInSession.class), Mockito.mock(String.class)))));
    }

    @Test
    public void shouldBeEqualToOtherHashCode() {
        assertThat(logOutUserResult.hashCode(), is(new LogOutUserResult(userInSession, null).hashCode()));
    }
