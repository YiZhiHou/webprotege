                ...
                new DispatchServiceCallbackWithProgressDisplay<CreateNewProjectResult>(errorDisplay,
                    ...
                    public void handleExecutionException(Throwable cause) {
                        if (cause instanceof PermissionDeniedException) {
                            messageBox.showMessage("您没有创建新项目的权限");
                        }
                            ...
                            messageBox.showMessage("项目名称 " + projectName + " 已经存在，请换个名字。");
                        }
                            ...
                            String projectName = ex.getProjectId().getId();
                            messageBox.showMessage("服务器上已存在id为 " + projectName + " 的非空项目，该项目尚未被覆盖。若要解决此问题，请与管理员联系。");
                        }
                        else {
