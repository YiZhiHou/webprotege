...
//                        PerspectiveId.get("Query")
                        PerspectiveId.get("类"),
                        PerspectiveId.get("OWL类"),
                        PerspectiveId.get("属性"),
                        PerspectiveId.get("OWL属性"),
                        PerspectiveId.get("个体"),
                        PerspectiveId.get("评论"),
                        PerspectiveId.get("实体变更"),
                        PerspectiveId.get("历史"),
                        PerspectiveId.get("查询")
                )
        );
    }
