...
public interface Messages extends com.google.gwt.i18n.client.Messages {
    ...
    @DefaultMessage("")
    @Key("change.revertChangesInRevisionSuffix")
    String change_revertChangesInRevisionSuffix();
    ...
    @Key("graph.newFilter")
    String graphNewFilter();

    @DefaultMessage("Set as project defaults")
    @Key("graph.setAsDefault")
    String graphSetAsDefault();
    ...
    @Key("graph.filterName")
    String graphFilterName();
    ...
    @DefaultMessage("Included Edges")
    @Key("graph.includedEdges")
    String graphIncludedEdges();

    @DefaultMessage("Excluded edges")
    @Key("graph.excludedEdges")
    String graphExcludedEdges();
    ...
    @DefaultMessage("Leave blank for no language tag.  Press 'Reset' to reset the language tag to the project default.)")
    @Key("setLanguageTagInstructions")
    String setLanguageTagInstructions();
    ...
    @DefaultMessage("Create from existing sources")
    @Key("projectSettings.createFromFile")
    String projectSettings_create_from_file();
