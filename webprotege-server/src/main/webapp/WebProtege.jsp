...
//            Optional<String> idToken = userDetailsManager.getIdToken(userId);
            if (email.isPresent()) {
                userDetails = UserDetails.getUserDetails(userId, userId.getUserName(), Optional.of(email.get()), Optional.of("empty id jsp token"));
            }
            else {
                userDetails = UserDetails.getUserDetails(userId, userId.getUserName(), Optional.<String>empty(), Optional.of("empty id jsp token"));
            }
        }
