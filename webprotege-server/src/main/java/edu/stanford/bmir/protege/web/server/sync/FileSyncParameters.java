...
/**
 * <p>
 *     Wraps a HttpServletRequest to enable information about a sync request to be extracted.
 * </p>
 */
public class FileSyncParameters {

    private HttpServletRequest request;

    public FileSyncParameters(HttpServletRequest request) {
        this.request = request;
    }

    /**
     * Determines if this is a request for a project sync.
     * @return <code>true</code> if this is a request for a project sync and the projectId is specified and the
     * id is well-formed, otherwise <code>false</code>.
     */
    public boolean isProjectSync() {
