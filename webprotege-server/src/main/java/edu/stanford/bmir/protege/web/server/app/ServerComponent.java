...
import edu.stanford.bmir.protege.web.server.sso.SsoServlet;
import edu.stanford.bmir.protege.web.server.sync.ProjectSyncServlet;
...
public interface ServerComponent {
    ...
    ProjectSyncServlet getProjectSyncServlet();

    SsoServlet getSsoServlet();
