...
public class UserDetails implements Serializable {
    ...
    public UserDetails(@Nonnull UserId userId,
                       ...
                       @Nonnull Optional<String> idToken) {
        this.userId = checkNotNull(userId);
        this.displayName = checkNotNull(displayName);
        this.emailAddress = emailAddress.orElse(null);
        this.idToken = idToken.orElse(null);
    }
    ...
    public static UserDetails getUserDetails(@Nonnull UserId userId,
        ...
        return new UserDetails(userId, displayName, Optional.of(emailAddress), Optional.of(idToken));
    }
    ...
    public static UserDetails getUserDetails(@Nonnull UserId userId,
                                             ...
                                             @Nonnull Optional<String> emailAddress,
                                             @Nonnull Optional<String> idToken) {
        return new UserDetails(userId, displayName, emailAddress, idToken);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(userId, displayName, emailAddress, idToken);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.userId.equals(other.userId)
                ...
                && this.getIdToken().equals(other.getIdToken());
    }
    ...
    public String toString() {
        return MoreObjects.toStringHelper("UserDetails")
                ...
                .add("idToken", Optional.ofNullable(idToken).orElse(""))
                .toString();
    }
}
